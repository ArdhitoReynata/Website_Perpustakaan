  ...
  <body>
    ...
    <section class="second-section" id="aboutsection">
      <div class="container d-flex align-items-right justify-content-center fs-1 text-black flex-column">
        <h2>Tentang</h2>
        <p></p>
        <p>Kami dengan bangga mempersembahkan aplikasi perpustakaan yang dibuat khusus untuk memenuhi kebutuhan dan kemauan para pengguna di Desa Wedoro. Kami percaya bahwa akses yang mudah dan nyaman terhadap bahan bacaan adalah hak bagi semua orang, dan kami berkomitmen untuk memberikan layanan terbaik kepada masyarakat kami.</p>
        <p>Aplikasi Perpustakaan Desa Wedoro dirancang dengan memperhatikan kebutuhan lokal, serta mempertimbangkan kemajuan teknologi. Dengan fitur-fitur yang mudah digunakan dan intuitif, kami ingin memastikan bahwa setiap pengguna dapat menikmati pengalaman membaca yang menyenangkan dan bermanfaat.</p>
        <p>Aplikasi Perpustakaan Desa Wedoro adalah wujud dari komitmen kami untuk menyediakan layanan perpustakaan yang inklusif, inovatif, dan berorientasi pada kebutuhan pengguna. Kami berharap aplikasi ini dapat menjadi sarana yang bermanfaat bagi seluruh masyarakat Desa Wedoro dalam mengeksplorasi dunia pengetahuan melalui bacaan. Terima kasih atas dukungan dan partisipasi Anda!</p>
      </div>
    </section>
      ...
      <div class="container d-flex text-center align-items-center justify-content-center fs-1 text-black flex-column">
        ...
        <div class="row">
          <div class="col-md-4">
            <p></p>
            <p>Alfan Dwi Cahya</p>
            <p>22082010228@student.upnjatim.ac.id</p>
            <hr>
            <a href="https://wa.me/62881036058125">
          ...
          <div class="col-md-4">
            <p></p>
            <p>Ardhito Reynata</p>
            <p>22082010233@student.upnjatim.ac.id</p>
            <hr>
            <a href="https://wa.me/6282139962799">
              <img src="assets/whatsapp.svg" alt="WhatsApp" width="40" height="40">
            </a>
          </div>
          <div class="col-md-4">
            <p></p>
            <p>Agung Andhika Saputra</p>
            <p>22082010249@student.upnjatim.ac.id</p>
            <hr>
            <a href="https://wa.me/6282139369286">
              <img src="assets/whatsapp.svg" alt="WhatsApp" width="40" height="40">
            </a>
          </div>
        </div>
